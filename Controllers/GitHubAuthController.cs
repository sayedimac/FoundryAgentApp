...
public class GitHubAuthController : Controller
{
    ...
    {
        var clientId = _configuration["GITHUB_APP_CLIENT_ID"];
        if (string.IsNullOrEmpty(clientId))
        {
            return BadRequest("GitHub App is not configured. Set GITHUB_APP_CLIENT_ID in configuration.");
        }
    ...
    public async Task<IActionResult> Callback([FromQuery] string code, [FromQuery] string state)
    {
        ...
        var clientId = _configuration["GITHUB_APP_CLIENT_ID"];
        var clientSecret = _configuration["GITHUB_APP_CLIENT_SECRET"];
